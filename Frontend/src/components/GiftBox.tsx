...
export default function GiftBoxAnimation({ setGiftData, ref, handleSetRef, handleChangeGiftClick, totalCoinsRef, giftData}: {ref: any,setGiftData: any, handleChangeGiftClick: () => void, totalCoinsRef: any, giftData: any; handleSetRef: (val: number) => void;}) {
  ...
  return (
    <div className="App">
      ...
      <div className={`img-container` }>
        <GiftCard ref={ref} handleSetRef={handleSetRef} setGiftData={setGiftData} handleChangeGiftClick={handleChangeGiftClick} giftData={giftData?.data} animation={state} giftType={giftData?.type} totalCoinsRef={totalCoinsRef}/>
