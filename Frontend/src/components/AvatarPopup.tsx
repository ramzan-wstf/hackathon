            ...
            <Modal
                ...
                footer={<div className='flex items-center gap-2 justify-end text-black'>
                    <div className='flex rounded-md justify-center items-center px-2 gap-3 py-1'>
                        {
                            (ownedAvatars?.find((elem: any) => elem?.id === `${el}`) !== undefined || ownedAvatars?.find((elem: any) => elem?.id === `${el}`) !== null || unlockedAvatars?.find((elem: any) => elem?.id === `${el}`) !== undefined || unlockedAvatars?.find((elem: any) => elem?.id === `${el}`) !== null) && <p onClick={() => {
                                handleBuySell(el);
